            ...
            <div class="wrapper row">
                <div class="preview col-md-6">
                    ...
                    <ul class="preview-thumbnail nav nav-tabs">
                        <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="../img/1-percent-retinol-c15-booster-duo-013-B.jpg" /></a></li>
                ...
                <div class="details col-md-6">
                    ...
                    <div class="action">
                        <a href="{{route('cart')}}}" style="text-decoration: none; color: white;"><button class="add-to-cart btn btn-default" type="button">add to cart</button></a>
